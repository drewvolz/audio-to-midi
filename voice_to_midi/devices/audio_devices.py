...
class AudioDeviceManager:
    ...
    def test_device(self, device: AudioDevice, duration: float = 1.0) -> bool:
        ...
        try:
            ...
            data = stream.read(int(device.sample_rate * duration), exception_on_overflow=False)
    ...
    def _refresh_devices(self) -> None:
        ...
        try:
            ...
            default_device_index = self._audio.get_default_input_device_info().get('index', -1)
